---
title: "Life for the first quarter of 2026!"
date: "2026-04-06"
...
<div className="my-8 p-6 bg-muted/50 rounded-lg border border-border text-left">
  <h4 className="font-semibold mb-4 text-lg">Why is this necessary?</h4>
  <p className="mb-4">You might be wondering—I’m currently taking on new projects. If you or your relatives want a job done great, or if you simply want to see me not die of starvation, reach out. Here is what I can do:</p>
  <ul className="space-y-2 list-none p-0">
    <li className="flex items-center gap-2">General Software Development (Rust/TS)</li>
    <li className="flex items-center gap-2">AI Integration & Automation</li>
    <li className="flex items-center gap-2">Scalable System Design</li>
    <li className="flex items-center gap-2">Helping you eat better (lmaooooo)</li>
  </ul>
</div>

### The Things I Didn't Mention

You might be surprised that I haven't mentioned school yet. For a final year student, school is actually the least of my problems right now. I’m just waiting for my final exams to come around so I can finally get TF out of this place and focus 100% on my unemployemnt(Sad).
...
![Superman Coder](/images/blog/superman.png)